    ...
    <body id="castle">
      ...
      <div>
        <div className="sl7">
          <Slider {...settings}>
            <div>
              <img className="imageF" src={img39} />
            </div>
            <div>
              <img className="imageF" src={img40} />
            </div>
            <div>
              <img className="imageF" src={img41} />
            </div>
            <div>
              <img className="imageF" src={img42} />
            </div>

            <div>
              <img className="imageF" src={img43} />
            </div>
            <div>
              <img className="imageF" src={img44} />
            </div>
            <div>
              <img className="imageF" src={img45} />
            </div>
          </Slider>
        </div>
        ...
        <div className="sl8">
          <Slider {...settings}>
            <div>
              <img className="imageF" src={img46} />
            </div>
            <div>
              <img className="imageF" src={img47} />
            </div>
            <div>
              <img className="imageF" src={img48} />
            </div>
            <div>
              <img className="imageF" src={img49} />
            </div>
            <div>
              <img className="imageF" src={img50} />
            </div>
            <div>
              <img className="imageF" src={img51} />
            </div>
            <div>
              <img className="imageF" src={img52} />
            </div>
            <div>
              <img className="imageF" src={img53} />
            </div>
            <div>
              <img className="imageF" src={img54} />
            </div>
            <div>
              <img className="imageF" src={img55} />
            </div>
            <div>
              <img className="imageF" src={img56} />
            </div>
          </Slider>
        </div>
      </div>
